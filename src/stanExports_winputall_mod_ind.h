...
namespace model_winputall_mod_ind_namespace {
...
static constexpr std::array<const char*, 77> locations_array__ =
  ...
  " (in 'string', line 70, column 11 to column 14)",
  ...
  " (in 'string', line 72, column 13 to column 16)",
...
class model_winputall_mod_ind final : public model_base_crtp<model_winputall_mod_ind> {
private:
  int T;
  int K;
...
public:
  ~model_winputall_mod_ind() {}
  model_winputall_mod_ind(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_winputall_mod_ind_namespace::model_winputall_mod_ind";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
    ...
    try {
      ...
      mu_1dim__ = (T * K);
      current_statement__ = 23;
      stan::math::validate_non_negative_index("mu", "T * K", mu_1dim__);
      current_statement__ = 24;
      beta_1dim__ = std::numeric_limits<int>::min();
      current_statement__ = 24;
      beta_1dim__ = (T * K);
      current_statement__ = 24;
      stan::math::validate_non_negative_index("beta", "T * K", beta_1dim__);
  ...
  inline std::string model_name() const final {
    return "model_winputall_mod_ind";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_winputall_mod_ind_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      stan::model::assign(beta, mod_rp_fun(mu, distrib_method, pstream__),
        "assigning variable beta");
      Eigen::Matrix<local_scalar_t__,-1,1> Xbeta =
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(T, DUMMY_VAR__);
      current_statement__ = 3;
      stan::model::assign(Xbeta, stan::math::multiply(big_s, beta),
        "assigning variable Xbeta");
      {
        current_statement__ = 5;
        lp_accum__.add(stan::math::multi_normal_lpdf<propto__>(mu, alpha,
                         omega));
        current_statement__ = 6;
        lp_accum__.add(stan::math::multi_normal_lpdf<propto__>(y, Xbeta,
                         sigma));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_winputall_mod_ind_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      double lupost = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 4;
      lupost = (stan::math::multi_normal_lpdf<false>(mu, alpha, omega) +
        stan::math::multi_normal_lpdf<false>(y, Xbeta, sigma));
      out__.write(lupost);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"beta", "Xbeta"};
      names__.reserve(names__.size() + temp.size());
      names__.insert(names__.end(), temp.begin(), temp.end());
    }
    if (emit_generated_quantities__) {
      std::vector<std::string> temp{"lupost"};
      names__.reserve(names__.size() + temp.size());
      names__.insert(names__.end(), temp.begin(), temp.end());
    }
  }
  ...
  constrained_param_names(std::vector<std::string>& param_names__, bool
    ...
    if (emit_generated_quantities__) {
      param_names__.emplace_back(std::string() + "lupost");
    }
  }
  inline void
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(mu_1dim__) + "},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(beta_1dim__) + "},\"block\":\"transformed_parameters\"},{\"name\":\"Xbeta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(T) + "},\"block\":\"transformed_parameters\"},{\"name\":\"lupost\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = mu_1dim__;
...
using stan_model = model_winputall_mod_ind_namespace::model_winputall_mod_ind;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_winputall_mod_ind_namespace::profiles__;
}
#endif
#endif
