...
#include "stanExports_winputall_mod_ind.h"

RCPP_MODULE(stan_fit4winputall_mod_ind_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_winputall_mod_ind")
