...
namespace model_imh_allx_ind_namespace {
...
static constexpr std::array<const char*, 121> locations_array__ =
  ...
  " (in 'string', line 87, column 2 to column 87)",
  " (in 'string', line 88, column 2 to column 64)",
  " (in 'string', line 89, column 2 to column 35)",
  " (in 'string', line 90, column 2 to column 56)",
  " (in 'string', line 91, column 2 to column 69)",
  ...
  " (in 'string', line 99, column 2 to column 12)",
  " (in 'string', line 86, column 2 to column 35)",
  " (in 'string', line 97, column 2 to column 24)",
  " (in 'string', line 98, column 2 to column 25)",
  " (in 'string', line 101, column 4 to column 74)",
  " (in 'string', line 102, column 4 to column 84)",
  ...
  " (in 'string', line 118, column 6 to column 42)",
  " (in 'string', line 119, column 6 to column 41)",
  " (in 'string', line 120, column 6 to column 22)",
  " (in 'string', line 116, column 11 to line 121, column 5)",
  " (in 'string', line 113, column 6 to column 38)",
  " (in 'string', line 114, column 6 to column 16)",
  " (in 'string', line 115, column 6 to column 30)",
  " (in 'string', line 111, column 16 to line 116, column 5)",
  " (in 'string', line 111, column 4 to line 121, column 5)",
  " (in 'string', line 122, column 4 to column 11)",
  " (in 'string', line 100, column 22 to line 123, column 3)",
  " (in 'string', line 100, column 2 to line 123, column 3)",
  ...
  " (in 'string', line 78, column 14 to column 17)",
  " (in 'string', line 78, column 2 to column 36)",
  " (in 'string', line 83, column 9 to column 15)",
  " (in 'string', line 83, column 17 to column 20)",
...
class model_imh_allx_ind final : public model_base_crtp<model_imh_allx_ind> {
private:
  int T;
  int K;
  int nb_sim;
  ...
  Eigen::Matrix<double,-1,1> m_beta_importance_data__;
  ...
  Eigen::Map<Eigen::Matrix<double,-1,1>> m_beta_importance{nullptr, 0};
  Eigen::Map<Eigen::Matrix<double,-1,-1>> omega_importance{nullptr, 0, 0};
public:
  ~model_imh_allx_ind() {}
  model_imh_allx_ind(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_imh_allx_ind_namespace::model_imh_allx_ind";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
    ...
    try {
      ...
      stan::math::validate_non_negative_index("m_beta_importance", "T * K",
        (T * K));
      current_statement__ = 60;
      context__.validate_dims("data initialization", "m_beta_importance",
        "double", std::vector<size_t>{static_cast<size_t>((T * K))});
      m_beta_importance_data__ = Eigen::Matrix<double,-1,1>::Constant((T *
                                   K),
                                   std::numeric_limits<double>::quiet_NaN());
      new (&m_beta_importance)
        Eigen::Map<Eigen::Matrix<double,-1,1>>(m_beta_importance_data__.data(),
        (T * K));
      {
        std::vector<local_scalar_t__> m_beta_importance_flat__;
        current_statement__ = 60;
        m_beta_importance_flat__ = context__.vals_r("m_beta_importance");
        current_statement__ = 60;
        pos__ = 1;
        current_statement__ = 60;
        for (int sym1__ = 1; sym1__ <= (T * K); ++sym1__) {
          current_statement__ = 60;
          stan::model::assign(m_beta_importance,
            m_beta_importance_flat__[(pos__ - 1)],
            "assigning variable m_beta_importance",
            stan::model::index_uni(sym1__));
          current_statement__ = 60;
          pos__ = (pos__ + 1);
        }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_imh_allx_ind_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_imh_allx_ind_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      double log_gg = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 4;
      log_gg = stan::math::multi_normal_lpdf<false>(beta_proposed,
                 m_beta_importance, omega_importance);
      ...
      while (stan::math::logical_lte(i, nb_sim)) {
        ...
        stan::model::assign(beta_proposed,
          stan::math::multi_normal_rng(m_beta_importance, omega_importance,
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    if (emit_generated_quantities__) {
      std::vector<std::string>
        temp{"beta_accept", "log_p_mean", "beta_proposed", "log_gg", "tbeta",
             "Xbeta", "log_pp_obs", "log_pp_mix", "log_pp", "p_t", "p_p",
             "R", "u", "i"};
  ...
  constrained_param_names(std::vector<std::string>& param_names__, bool
    ...
    if (emit_generated_quantities__) {
      ...
      param_names__.emplace_back(std::string() + "log_gg");
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta_accept\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(nb_sim) + ",\"cols\":" + std::to_string(beta_accept_2dim__) + "},\"block\":\"generated_quantities\"},{\"name\":\"log_p_mean\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(nb_sim) + "},\"block\":\"generated_quantities\"},{\"name\":\"beta_proposed\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(beta_proposed_1dim__) + "},\"block\":\"generated_quantities\"},{\"name\":\"log_gg\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"tbeta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(tbeta_1dim__) + "},\"block\":\"generated_quantities\"},{\"name\":\"Xbeta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(T) + "},\"block\":\"generated_quantities\"},{\"name\":\"log_pp_obs\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"log_pp_mix\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"log_pp\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"p_t\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"p_p\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"R\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"u\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"i\",\"type\":{\"name\":\"int\"},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_gen_quantities = emit_generated_quantities *
      (((((((((((((((nb_sim * beta_accept_2dim__) + nb_sim) +
      beta_proposed_1dim__) + 1) + tbeta_1dim__) + T) + 1) + 1) + 1) + 1) +
      1) + 1) + 1) + 1));
...
using stan_model = model_imh_allx_ind_namespace::model_imh_allx_ind;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_imh_allx_ind_namespace::profiles__;
}
#endif
#endif
